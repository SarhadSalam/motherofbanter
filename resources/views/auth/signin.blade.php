		...
		<form class="form-signin" role="form" method="post" action="{{ route ('auth.signin')}}" data-parsley-validate>
			...
			<div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
				...
				<input type="text" name="login" class="form-control" id="email"
					   value="{{ Request::old('email') ?: '' }}" placeholder="Email or Username" autofocus required=""
			...
			<div class="form-group text-center forget-password"><a href="/register/forgot_password">Forgot your
					password?</a></div>
